...
1. I left the input BNC (J3) off of mine and ran a internal wire to the clock output. The BNC could be added by those that want the ability to loop the clock or any other suitable input back into the distribution amp.
1. Item x
   1. Item xa
   1. Item xb
